...
export default {
  ...
  methods: {
    ...
    edit() {
      ...
      PatientService.updatePatient(this.patientToEdit.id, this.patientToEdit)
        .then((res) => {
          this.$emit("message", "Pomyślnie edytowano pacjenta");
